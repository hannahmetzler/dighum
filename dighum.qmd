...
- For this, we need to know which problems to focus on, focusing only on social media is the wrong scapegoat, a distraction. 
- Use social media wisely, transparency, better algorithms, etc. but don't forget about the actual causes

Somewhere: some of these questions by them:  
